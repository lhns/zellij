...
## [Unreleased]
* fix: add configurable `escape_sequence_timeout` so fragmented mouse/escape sequences over laggy links (e.g. multi-hop SSH) no longer leak stray characters (https://github.com/zellij-org/zellij/issues/4894)
